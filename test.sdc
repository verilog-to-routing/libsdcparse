...
set_false_path -from {asdf/ff qwert/asd/ff} -to [get_clocks{output_clk}]
set_false_path -from {asdf/ff2} -to [get_clocks{output_clk}]
set_max_delay 17 -from [get_clocks{input_clk}] -to [get_clocks{output_clk}]
set_multicycle_path 5 -setup -from [get_clocks{clk}] -to [get_clocks{clk2}]
