...
//set_false_path
std::shared_ptr<SetFalsePath> sdc_set_false_path_add_to_from_group(const Lexer& lexer, std::shared_ptr<SetFalsePath> sdc_set_false_path, StringGroup group, FromToType to_from_dir);
...
std::shared_ptr<SetMulticyclePath> sdc_set_multicycle_path_add_to_from_group(const Lexer& lexer, std::shared_ptr<SetMulticyclePath> sdc_set_multicycle_path, StringGroup group, FromToType to_from_dir);
