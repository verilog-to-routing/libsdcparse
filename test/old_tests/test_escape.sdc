...
puts [libsdcparse_create_port "n101" -direction INPUT]
puts [libsdcparse_create_port "clock" -direction INPUT]
puts [libsdcparse_create_port "clk[0]" -direction INPUT]
puts [libsdcparse_create_port "obj_q:obj_q\|altclklock0_wrap:b2v_inst10\|altclklock0:component1\|altpll:altpll_component\|altpll_bnf2:auto_generated\|clk\[0\]" -direction INPUT]
