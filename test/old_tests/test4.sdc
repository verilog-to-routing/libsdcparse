...
puts [libsdcparse_create_port "OSC_CLK" -direction INPUT]
puts [libsdcparse_create_port "pll:pll_inst|altpll:altpll_component|pll_altpll:auto_generated|wire_pll1_clk\[0\]" -direction INPUT]
