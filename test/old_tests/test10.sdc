...
puts [libsdcparse_create_port "clka" -direction INPUT]
puts [libsdcparse_create_port "clkb" -direction INPUT]
puts [libsdcparse_create_port "clkc" -direction INPUT]
puts [libsdcparse_create_port "clkd" -direction INPUT]
