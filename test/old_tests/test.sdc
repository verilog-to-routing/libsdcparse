...
# CHECK: [[clk0_port_ptr:__vtr_obj_[0-9]+]]
...
# CHECK: [[clk3_port_ptr:__vtr_obj_[0-9]+]]
...
# CHECK: [[top_clk_port_ptr:__vtr_obj_[0-9]+]]
puts [libsdcparse_create_port "top^clk" -direction INPUT]
# CHECK: [[asdf_port_ptr:__vtr_obj_[0-9]+]]
puts [libsdcparse_create_port "asdf" -direction INPUT]
# CHECK: [[qwerty_port_ptr:__vtr_obj_[0-9]+]]
...
# CHECK: clk0: [[clk0_clock_ptr:__vtr_obj_[0-9]+]]
puts "clk0: [get_clocks clk0]"
# CHECK: clk2: [[clk2_clock_ptr:__vtr_obj_[0-9]+]]
puts "clk2: [get_clocks clk2]"
# CHECK: clk3: [[clk3_clock_ptr:__vtr_obj_[0-9]+]]
puts "clk3: [get_clocks clk3]"
# CHECK: input_clk: [[input_clk_clock_ptr:__vtr_obj_[0-9]+]]
puts "input_clk: [get_clocks input_clk]"
# CHECK: input_clock2: [[input_clock2_clock_ptr:__vtr_obj_[0-9]+]]
puts "input_clock2: [get_clocks input_clock2]"
# CHECK: asdf: [[asdf_clock_ptr:__vtr_obj_[0-9]+]]
puts "asdf: [get_clocks asdf]"
# CHECK: qwerty: [[qwerty_clock_ptr:__vtr_obj_[0-9]+]]
puts "qwerty: [get_clocks qwerty]"
# CHECK: output_clk: [[output_clk_clock_ptr:__vtr_obj_[0-9]+]]
