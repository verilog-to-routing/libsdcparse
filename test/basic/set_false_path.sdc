...
# CHECK: virtual: [[virtual_ptr:[0-9]+]]
puts "virtual: [libsdcparse_get_object_id_value_internal [get_clocks virtual]]"
...
# CHECK: set_false_path -from {[[clk1_ptr]] 0} -to {[[virtual_ptr]]}
