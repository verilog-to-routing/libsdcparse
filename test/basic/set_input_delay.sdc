...
puts [_libsdcparse_create_port "in4" -type INPUT]
# CHECK-NEXT: [[A1_port_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "A1" -type INPUT]
# CHECK-NEXT: [[A2_port_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "A2" -type INPUT]
# CHECK-NEXT: [[A3_port_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "A3" -type INPUT]
# CHECK-NEXT: [[A4_port_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "A4" -type INPUT]
