...
# CHECK: virtual1: [[virtual1_ptr:[0-9]+]]
puts "virtual1: [libsdcparse_get_object_id_value_internal [get_clocks virtual1]]"
# CHECK: virtual2: [[virtual2_ptr:[0-9]+]]
puts "virtual2: [libsdcparse_get_object_id_value_internal [get_clocks virtual2]]"
# CHECK: virtual3: [[virtual3_ptr:[0-9]+]]
puts "virtual3: [libsdcparse_get_object_id_value_internal [get_clocks virtual3]]"
