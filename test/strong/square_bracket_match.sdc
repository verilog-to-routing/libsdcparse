...
puts [_libsdcparse_create_port "A\[1\]" -type INPUT]
# CHECK: [[A2_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "A\[2\]" -type INPUT]
# CHECK: [[A3_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "A\[3\]" -type INPUT]
# CHECK: [[B0_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "B\[0\]" -type INPUT]
# CHECK: [[B1_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "B\[1\]" -type INPUT]
# CHECK: [[B2_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "B\[2\]" -type INPUT]
# CHECK: [[B3_ptr:__vtr_obj_port_[0-9]+]]
puts [_libsdcparse_create_port "B\[3\]" -type INPUT]
